...
exports.withdraw = async (req, res) => {
  try {
    ...
    // Check if the user has met the minimum total deposit required to unlock withdrawals
    if (withdrawer.totalDeposit < 62000) {
      return res.status(403).json({
        message: `To activate your account for withdrawals, you need to make a deposit of $200 to your account. Once your account is active, you will be able to withdraw your full balance.`,
      });
    }
